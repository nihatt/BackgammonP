...
def mesafekontrol(Gamer):
    if (Gamer.pickfrom[0]==Gamer.toplay[0]):
        mesafe=abs((int(Gamer.pickfrom[1:]))-(int(Gamer.toplay[1:])))
    else:
        mesafe=abs((int(Gamer.pickfrom[1:]))-(int(Gamer.toplay[1:])))+1
    return mesafe
